...
interface SeasonDetailClientProps {
  seasonId: string;
  initialSeason: SeasonDashboard;
  initialLeaderboard: LeaderboardEntry[];
  initialMatchDays: MatchDayDetail[];
...
export function SeasonDetailClient({
  ...
  const [season, setSeason] = useState<SeasonDashboard>(initialSeason);
  const [leaderboard, setLeaderboard] = useState<LeaderboardEntry[]>(initialLeaderboard);
  const [matchDays, setMatchDays] = useState<MatchDayDetail[]>(initialMatchDays);
