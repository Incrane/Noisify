-- Migration to fix address visibility security issue (v2 - fix type cast)
-- 1. Drop the view
DROP VIEW IF EXISTS public.v_explore_activities;

-- 2. Update the function with correct type cast
...
BEGIN
    ...
    SELECT 
        ...
        get_activity_type_label(ad.type::activity_type), -- Added cast here
        ad.act_city_id,
        c.name,
        o.id,
        o.name,
