-- Migration to fix address visibility security issue (v3 - remove missing function call)
-- 1. Drop the view
DROP VIEW IF EXISTS public.v_explore_activities;

-- 2. Update the function to use CASE statement instead of missing function
